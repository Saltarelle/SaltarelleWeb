...
namespace System.Html.Media.Graphics {
	...
	public enum CompositeOperation {
		...
		/// </summary>
		[ScriptName("destination-atop")] DestinationAtop = 1,
		...
		/// </summary>
		[ScriptName("destination-in")] DestinationIn = 2,
		...
		/// </summary>
		[ScriptName("source-atop")] SourceAtop = 6,
		...
		/// </summary>
		[ScriptName("source-over")] SourceOver = 9,
